...
CAP['dashboard-agricultura.html'] = [
  ...
  ('lista os retirados',    lambda s: 'var RETIRADOS' in s and s.count("['") >= 7),
...
CAP['indicadores-painel.html'] = [
  ...
  ('barra da fonte única',  lambda s: 'assets/nav-sinagepe.js' in s and 'nav-mount' in s),
  ('pesquisa global',       lambda s: 'assets/pesquisa-sinagepe.js' in s),
  ('todos clicáveis',       lambda s: 'Ver como se chega' in s),
  ...
  ('lista os retirados',    lambda s: 'desenharRetirados' in s),
]
...
ASSETS = {
 'assets/nav-sinagepe.js': [
   ...
   ('portais por perfil',   lambda s: all(x in s for x in ['portal-comerciantes.html','portal-parceiros.html','portal-publico.html','portal-universidades.html'])),
