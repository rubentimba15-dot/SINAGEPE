...
(function (global) {
  ...
  var ECRAS = [
    ...
    { h:'comercio-externo.html', n:'Comércio externo', d:'Metas do PEDSA para importação e exportação, e as fontes que faltam para as medir',
      t:'comercio externo importacao exportacao pedsa meta arroz dependencia ine alfandegas' },
    { h:'series-precos.html', n:'Série de preços', d:'Oito edições do boletim do SIMA, com evolução por produto e amplitude entre praças',
      t:'serie precos sima boletim quente-quente evolucao amplitude praca milho arroz' },
