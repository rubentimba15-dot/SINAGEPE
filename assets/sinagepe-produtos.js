...
var PRODUTOS = (() => {
  ...
  const META = {
    'arroz':            { slug:'arroz',            forma:'saco',    cor:'#F5DDB8', grao:'#F1E3C6' },
    ...
    'cimento nacional': { slug:'cimento',          forma:'cimento', cor:'#9FB0C4', grao:'#D6E1EE' },
    'cimento':          { slug:'cimento',          forma:'cimento', cor:'#9FB0C4', grao:'#D6E1EE' },
    ...
    'jet a-1':          { slug:'jet',              forma:'tanque',  cor:'#BFA9FF', grao:'#D6C9FD' },
  ...
  const meta = nome => META[String(nome||'').trim().toLowerCase()]
    || { slug:'generico', forma:'caixa', cor:'#EDB86E', grao:'#F5DDB8' };
  ...
  function ilustracao(nome, tamanho) {
    ...
    if (m.forma === 'saco') {
      corpo = `<path d="M40 44c0-6 3-10 6-13l-3-8h34l-3 8c3 3 6 7 6 13v46a8 8 0 0 1-8 8H48a8 8 0 0 1-8-8V44Z" fill="${C}"/>
        ...
        <path d="M46 52h28M46 62h28" stroke="#0E1A2B" stroke-width="2.4" opacity=".38" stroke-linecap="round"/>
        <rect x="48" y="70" width="24" height="15" rx="2" fill="#0E1A2B" opacity=".3"/>
      ...
      corpo = `<path d="M34 42c0-5 4-8 8-9l-2-9h40l-2 9c4 1 8 4 8 9v44a9 9 0 0 1-9 9H43a9 9 0 0 1-9-9V42Z" fill="${C}"/>
        ...
        <rect x="44" y="50" width="32" height="19" rx="2" fill="#0E1A2B" opacity=".34"/>
        <path d="M48 57h24M48 63h16" stroke="${m.grao}" stroke-width="2" opacity=".65" stroke-linecap="round"/>
        <path d="M42 78h36M42 85h28" stroke="#0E1A2B" stroke-width="2" opacity=".28" stroke-linecap="round"/>`;
      ...
      corpo = `<path d="M52 22h16v12l8 11v45a8 8 0 0 1-8 8H52a8 8 0 0 1-8-8V45l8-11V22Z" fill="${C}"/>
        ...
        <rect x="46" y="58" width="28" height="22" rx="3" fill="#0E1A2B" opacity=".35"/>
      ...
      corpo = `<g fill="${C}">
        ...
        <g stroke="#0E1A2B" stroke-width="1.6" opacity=".4" fill="none">
      ...
      corpo = `<rect x="30" y="26" width="40" height="66" rx="6" fill="${C}"/>
        <rect x="37" y="34" width="26" height="18" rx="3" fill="#0E1A2B" opacity=".45"/>
        <path d="M41 40h18M41 46h11" stroke="${m.grao}" stroke-width="2" opacity=".8" stroke-linecap="round"/>
        <rect x="37" y="60" width="26" height="5" rx="2.5" fill="#0E1A2B" opacity=".3"/>
      ...
      corpo = `<path d="M32 34h34a6 6 0 0 1 6 6v50a6 6 0 0 1-6 6H32a6 6 0 0 1-6-6V40a6 6 0 0 1 6-6Z" fill="${C}"/>
        ...
        <rect x="34" y="52" width="30" height="22" rx="3" fill="#0E1A2B" opacity=".38"/>
      ...
      corpo = `<rect x="20" y="42" width="80" height="38" rx="19" fill="${C}"/>
        <path d="M39 42v38M61 42v38M81 42v38" stroke="#0E1A2B" stroke-width="1.6" opacity=".35"/>
        <rect x="46" y="30" width="28" height="12" rx="4" fill="${m.cor}" opacity=".85"/>
        <circle cx="36" cy="88" r="7" fill="#0E1A2B" opacity=".55"/><circle cx="84" cy="88" r="7" fill="#0E1A2B" opacity=".55"/>
      ...
      corpo = `<path d="M38 40h44a6 6 0 0 1 6 6v44a6 6 0 0 1-6 6H38a6 6 0 0 1-6-6V46a6 6 0 0 1 6-6Z" fill="${C}"/>
        ...
        <rect x="42" y="58" width="36" height="20" rx="3" fill="#0E1A2B" opacity=".38"/>
      ...
      corpo = `<path d="M60 22l34 17v42L60 98 26 81V39l34-17Z" fill="${C}"/>
        <path d="M26 39l34 17 34-17M60 56v42" stroke="#0E1A2B" stroke-width="2" opacity=".35" fill="none"/>
        <path d="M26 39l34 17 34-17L60 22 26 39Z" fill="#fff" opacity=".12"/>`;
    } else {
      corpo = `<rect x="32" y="34" width="56" height="56" rx="6" fill="${C}"/>
        <rect x="42" y="46" width="36" height="20" rx="3" fill="#0E1A2B" opacity=".33"/>
        <path d="M32 52h56" stroke="#0E1A2B" stroke-width="2" opacity=".3"/>
    ...
    return `<svg width="${s}" height="${s}" viewBox="0 0 120 120" role="img" aria-label="Ilustração de ${nome}">${defs}${fundo}${corpo}
      <path d="M1 16V7a6 6 0 0 1 6-6h9" stroke="#EDB86E" stroke-width="1.4" fill="none" opacity=".8"/>
      <path d="M119 104v9a6 6 0 0 1-6 6h-9" stroke="#EDB86E" stroke-width="1.4" fill="none" opacity=".8"/></svg>`;
  }
